...
export default function HighlightEdit({id, name}) {
...
const { data, setData, put, processing, errors, reset } = useForm({
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    put(route('highlight.update',id));
  };
 
   return (
     <div className='py-8'>
    <h2 className='text-center text-gray-700 font-bold my-5'>Edit Highlight {name} </h2>
