...
export default function TagCreate({postType}) {
   ...
   return (
     <div className='py-8'>
    <h2 className='text-center text-gray-700 font-bold my-5'>Create New Tag for <span className='text-teal-600 text-lg'> {postType.name} </span> </h2>
